...
-- Generated: 2026-01-15T15:05:22.051718
-- Dialect: spark
-- Total MVs: 71
...
-- QBs: q19.sql::qb::main:0::root, q27.sql::qb::main:0::root, q34.sql::qb::subquery:1::root.from.subquery1, q43.sql::qb::main:0::root, q46.sql::qb::subquery:1::root.from.subquery1, ... (18 total)
-- Columns: 46 columns
-- Grouping: rollup
-- Grouping Signature: ROLLUP::item.i_item_id,store.s_state
...
-- QBs: q36.sql::qb::main:0::root, q70.sql::qb::main:0::root
-- Columns: 14 columns
-- Grouping: rollup
-- Grouping Signature: ROLLUP::item.i_category,item.i_class
-- Strategy: preserve (All aggregates support rollup)
-- ============================================================
...
-- QBs: q61.sql::qb::subquery:1::root.from.subquery1, q7.sql::qb::main:0::root
-- Columns: 22 columns
-- ============================================================
...
-- QBs: q14a.sql::qb::union_branch:1::root.with.cross_items.join.subquery1.intersect.left.intersect.left, q14b.sql::qb::union_branch:1::root.with.cross_items.join.subquery1.intersect.left.intersect.left
-- Columns: 8 columns
-- ============================================================
...
-- QBs: q10.sql::qb::subquery:1::root.exists.exists1, q11.sql::qb::union_branch:1::root.with.year_total.union.left, q14a.sql::qb::union_branch:4::root.with.avg_sales.from.subquery2.union.left.union.left, q14a.sql::qb::union_branch:7::root.from.subquery3.union.left.union.left, q14b.sql::qb::subquery:3::root.from.subquery3, ... (55 total)
-- Columns: 35 columns
-- Grouping: rollup
-- Grouping Signature: ROLLUP::item.i_item_id
-- Strategy: preserve (All aggregates support rollup)
...
-- MV: mv_021
-- Fact Table: store_sales
-- Tables: store, store_sales
-- Edges: store.s_store_sk=store_sales.ss_store_sk
-- QBs: q19.sql::qb::main:0::root, q27.sql::qb::main:0::root, q34.sql::qb::subquery:1::root.from.subquery1, q36.sql::qb::main:0::root, q43.sql::qb::main:0::root, ... (29 total)
-- Columns: 28 columns
-- Grouping: rollup
-- Grouping Signature: ROLLUP::store.s_state
-- Strategy: preserve (All aggregates support rollup)
-- ============================================================
...
-- QBs: q11.sql::qb::union_branch:1::root.with.year_total.union.left, q19.sql::qb::main:0::root, q23a.sql::qb::cte:best_ss_customer::root.with.best_ss_customer, q23a.sql::qb::subquery:1::root.with.max_store_sales.from.subquery1, q23b.sql::qb::cte:best_ss_customer::root.with.best_ss_customer, ... (12 total)
-- Columns: 21 columns
-- ============================================================
...
-- QBs: q64.sql::qb::cte:cross_sales::root.with.cross_sales, q80.sql::qb::cte:ssr::root.with.ssr
-- Columns: 24 columns
-- ============================================================
...
-- QBs: q17.sql::qb::main:0::root, q24a.sql::qb::cte:ssales::root.with.ssales, q24b.sql::qb::cte:ssales::root.with.ssales, q25.sql::qb::main:0::root, q29.sql::qb::main:0::root, ... (8 total)
-- Columns: 38 columns
-- ============================================================
...
-- Tables: item, store_sales
-- Edges: item.i_item_sk=store_sales.ss_item_sk
-- QBs: q17.sql::qb::main:0::root, q24a.sql::qb::cte:ssales::root.with.ssales, q24b.sql::qb::cte:ssales::root.with.ssales, q25.sql::qb::main:0::root, q29.sql::qb::main:0::root, ... (9 total)
-- Columns: 31 columns
-- ============================================================
...
-- QBs: q10.sql::qb::subquery:2::root.exists.exists2, q11.sql::qb::union_branch:2::root.with.year_total.union.right, q12.sql::qb::main:0::root, q14a.sql::qb::union_branch:6::root.with.avg_sales.from.subquery2.union.right, q14a.sql::qb::union_branch:9::root.from.subquery3.union.right, ... (31 total)
-- Columns: 38 columns
-- ============================================================
...
-- MV: mv_049
-- Fact Table: web_sales
-- Tables: date_dim, web_page, web_sales
-- Edges: date_dim.d_date_sk=web_sales.ws_sold_date_sk, web_page.wp_web_page_sk=web_sales.ws_web_page_sk
-- QBs: q77.sql::qb::cte:ws::root.with.ws, q85.sql::qb::main:0::root
-- Columns: 12 columns
-- ============================================================
...
-- QBs: q77.sql::qb::cte:ws::root.with.ws, q85.sql::qb::main:0::root, q90.sql::qb::subquery:1::root.from.subquery1, q90.sql::qb::subquery:2::root.join.subquery2
-- Columns: 12 columns
-- ============================================================
...
-- MV: mv_054
-- Fact Table: web_sales
-- Tables: web_sales, web_site
-- Edges: web_sales.ws_web_site_sk=web_site.web_site_sk
-- QBs: q62.sql::qb::main:0::root, q80.sql::qb::cte:wsr::root.with.wsr
-- Columns: 13 columns
-- ============================================================
...
-- Columns: 22 columns
-- Grouping: rollup
-- Grouping Signature: ROLLUP::customer_address.ca_country,customer_address.ca_county,customer_address.ca_state
-- Strategy: preserve (All aggregates support rollup)
-- ============================================================
...
-- Columns: 21 columns
-- Grouping: rollup
-- Grouping Signature: ROLLUP::item.i_brand,item.i_category,item.i_class,item.i_product_name
-- Strategy: preserve (All aggregates support rollup)
-- ============================================================
...
-- QBs: q40.sql::qb::main:0::root, q75.sql::qb::union_branch:1::root.with.all_sales.from.subquery1.union.left.union.left, q78.sql::qb::cte:cs::root.with.cs, q80.sql::qb::cte:csr::root.with.csr
-- Columns: 29 columns
-- ============================================================
CREATE VIEW mv_067 AS
SELECT
  cs.cs_bill_customer_sk,
  cs.cs_item_sk,
  d.d_year,
